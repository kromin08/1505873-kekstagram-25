...
const description = ['Отель и море', 'Указатель к пляжу', 'Сейшеллы', 'Фотобикини',
  'Онсен-Кари', 'МакЛарен', 'Диета по японски', 'Морс', 'Пляж и самолёт', 'Удобство хранения', 'Тропинка к пляжу',
...
const getNewObjects = () => {
  ...
  return {
    ...
    comments: getCommentsArray(getRandomIntInclusive(1, 3)),
    description: description[currentID - 1],
  };
};
